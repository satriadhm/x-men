...
<html lang="en">
    <head>
        ...
        <title>XMEN Client Dashboard</title>
        <!--     Fonts and icons     -->
        <link
        ...
        <link
            id="pagestyle"
            href="{{ url('dashboard/assets/css/argon-dashboard.css?v=2.0.4') }}"
            rel="stylesheet"
        />
    </head>
    ...
    <body class="g-sidenav-show bg-gray-100">
        ...
        >
            <div class="sidenav-header">
                ...
                >
                    <img
                        src="{{ url('dashboard/assets/img/logo-ct-dark.png') }}"
                        class="navbar-brand-img h-100"
                        alt="main_logo"
                    />
                    <span class="ms-1 font-weight-bold">XMEN Talent</span>
                </a>
            </div>
